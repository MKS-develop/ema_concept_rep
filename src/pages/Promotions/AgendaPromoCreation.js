...
function AgendaPromoCreation() {
    const [btnMessage, setBtnMessage] = useState("Crear agenda");
    ...
    function slots(dates){
    
        try{
            firebase.db.collection("Promociones").doc(data.state.promoId).update({
                agendaContiene: true,
                tipoAgenda: "Slots",
